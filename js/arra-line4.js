...
class ObjectFactory {
  static createObject(type, x, y) {
    const objectConfigs = {
      'door': { width: 30, height: 30, image: './img/dvercloses.png', label: 'Дверь закрытая' },
      'door2': { width: 30, height: 30, image: './img/dverwentoknowood.png', label: 'Дверь деревянная с вентоткном' },
      'door3': { width: 40, height: 30, image: './img/dverventrech.png', label: 'Дверь с вентрешеткой' },
      'door4': { width: 30, height: 30, image: './img/dveropenmetall.png', label: 'Дверь металлическая открытая' },
      'fan': { width: 40, height: 40, image: './img/fan.png', label: 'Вентилятор основной' },
      'fan2': { width: 40, height: 40, image: './img/fan2.png', label: 'Вентилятор' },
      'fire': { width: 40, height: 40, image: './img/fire.png', label: 'Огонь' },
      'fire2': { width: 40, height: 40, image: './img/pozarniigidrant.png', label: 'Пожарный гидрант' },
      'boom': { width: 40, height: 40, image: './img/massovievzivniepaboti.png', label: 'Массовые взрывные работы' },
      'boom2': { width: 40, height: 40, image: './img/vzrivnieraboti.png', label: 'Взрывные работы' },
      'medical': { width: 40, height: 40, image: './img/medpunkt.png', label: 'Медицинский пункт' },
      'building': { width: 30, height: 30, image: './img/nadshahtnoe.png', label: 'Надшахтное строение' },
      'pumps': { width: 40, height: 40, image: './img/nanospogruznoi.png', label: 'Насос погружной' },
      'pumps2': { width: 40, height: 40, image: './img/nasosnayastancia.png', label: 'Насосная станция' },
      'people': { width: 40, height: 40, image: './img/people.png', label: 'Люди' },
      'jumper': { width: 30, height: 30, image: './img/petemichkabeton.png', label: 'Перемычка бетонная' },
      'jumper2': { width: 30, height: 30, image: './img/petemichkakirpich.png', label: 'Перемычка кирпичная' },
      'jumper3': { width: 30, height: 30, image: './img/petemichkametall.png', label: 'Перемычка металлическая' },
      'jumper4': { width: 30, height: 30, image: './img/petemichkawood.png', label: 'Перемычка деревянная' },
      'phone': { width: 40, height: 40, image: './img/phone.png', label: 'Телефон' },
      'equipment': { width: 40, height: 40, image: './img/samohodnoe.png', label: 'Самоходное оборудование' },
      'entrance': { width: 40, height: 20, image: './img/zapasvhod.png', label: 'Запасной вход' }
    };
  ...
  static getObjectTypes() {
    return [
      { type: 'door', name: 'Дверь закрытая', icon: './img/dvercloses.png', category: 'doors_windows' },
      { type: 'door2', name: 'Дверь деревянная с вентоткном', icon: './img/dverwentoknowood.png', category: 'doors_windows' },
      { type: 'door3', name: 'Дверь с вентрешеткой', icon: './img/dverventrech.png', category: 'doors_windows' },
      { type: 'door4', name: 'Дверь металлическая открытая', icon: './img/dveropenmetall.png', category: 'doors_windows' },
      { type: 'fan', name: 'Вентилятор основной', icon: './img/fan.png', category: 'fan' },
      { type: 'fan2', name: 'Вентилятор', icon: './img/fan2.png', category: 'fan' },
      { type: 'fire', name: 'Огонь', icon: './img/fire.png', category: 'fire' },
      { type: 'fire2', name: 'Пожарный гидрант', icon: './img/pozarniigidrant.png', category: 'fire' },
      { type: 'boom', name: 'Массовые взрывные работы', icon: './img/massovievzivniepaboti.png', category: 'boom' },
      { type: 'boom2', name: 'Взрывные работы', icon: './img/vzrivnieraboti.png', category: 'boom' },
      { type: 'medical', name: 'Медицинский пункт', icon: './img/medpunkt.png', category: 'medical' },
      { type: 'building', name: 'Надшахтное строение', icon: './img/nadshahtnoe.png', category: 'building' },
      { type: 'pumps', name: 'Насос погружной', icon: './img/nanospogruznoi.png', category: 'pumps' },
      { type: 'pumps2', name: 'Насосная станция', icon: './img/nasosnayastancia.png', category: 'pumps' },
      { type: 'people', name: 'Люди', icon: './img/people.png', category: 'people' },
      { type: 'jumper', name: 'Перемычка бетонная', icon: './img/petemichkabeton.png', category: 'jumper' },
      { type: 'jumper2', name: 'Перемычка кирпичная', icon: './img/petemichkakirpich.png', category: 'jumper' },
      { type: 'jumper3', name: 'Перемычка металлическая', icon: './img/petemichkametall.png', category: 'jumper' },
      { type: 'jumper4', name: 'Перемычка деревянная', icon: './img/petemichkawood.png', category: 'jumper' },
      { type: 'phone', name: 'Телефон', icon: './img/phone.png', category: 'phone' },
      { type: 'equipment', name: 'Самоходное оборудование', icon: './img/samohodnoe.png', category: 'equipment' },
      { type: 'entrance', name: 'Запасной вход', icon: './img/zapasvhod.png', category: 'entrance' }
    ];
  }
}
...
class Editor {
  constructor(canvasId) {
    ...
    this.intersectionPoints = []; // Теперь массив объектов IntersectionPoint
  ...
  // НОВЫЙ МЕТОД: Объединение близких точек пересечения
  ...
  // ОБНОВЛЕННЫЙ МЕТОД: Поиск пересечений с объединением точек
  findIntersections() {
  ...
  // Остальные методы остаются без изменений, но добавляем isPointOnLineSegment
  ...
  splitLine(line, splitPoint) {
    ...
    const line1 = { ...line, id: Date.now() + Math.random(), start: { ...line.start }, end: { ...splitPoint } };
    const line2 = { ...line, id: Date.now() + Math.random() + 1, start: { ...splitPoint }, end: { ...line.end } };
  ...
  startMoving(pos) {
    ...
    if (this.selectedElement) {
      this.isMoving = true;
      this.dragOffset = { x: pos.x - this.selectedElement.x, y: pos.y - this.selectedElement.y };
      return;
    }
    ...
    if (this.selectedElement) {
      this.isMoving = true;
      this.dragOffset = { x: pos.x - this.selectedElement.start.x, y: pos.y - this.selectedElement.start.y };
    }
  }
  ...
  // ОБНОВЛЕННЫЙ МЕТОД: Отрисовка точек пересечения с ID
  drawIntersectionPoints() {
    this.intersectionPoints.forEach((point, index) => {
      this.ctx.save();

      // Цвет зависит от количества пересечений в точке
      ...
      this.ctx.fillText(label, point.x, point.y - 8);

      // Дополнительная информация при наведении (в виде тултипа)
...
document.getElementById('exportIntersections').addEventListener('click', () => {
  const points = editor.intersectionPoints;
  let message = `Найдено точек пересечения: ${points.length}\n\n`;

  points.forEach((point, index) => {
    console.log(point.formula);
    message += `Точка ${index + 1} (ID: ${point.id}):\n`;
    message += `  Координаты: (${point.x.toFixed(1)}, ${point.y.toFixed(1)})\n`;
    message += `  Количество пересечений: ${point.intersections.length}\n`;

    point.intersections.forEach((intersection, i) => {

      if (intersection.type === 'line-object') {
        message += `  Пересечение ${i + 1}: линия с объектом "${intersection.object.label}"\n`;
      } else if (intersection.type === 'line-line') {
        message += `  Пересечение ${i + 1}: пересечение двух линий\n`;
      }
    });
    message += '\n';
  });
  ...
  console.log(message);
  alert(`Данные выведены в консоль. Всего точек: ${points.length}`);
});